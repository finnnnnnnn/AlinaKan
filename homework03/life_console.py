...
if __name__ == "__main__":
    analyz = argparse.ArgumentParser()
    analyz.add_argument("--rows", "-r", type=int, default=4, help="Количество строк")
    analyz.add_argument("--cols", "-c", type=int, default=30, help="Количество столбцов")
    analyz.add_argument("--random", action="store_true", default=True, help="Рандом")
    analyz.add_argument(
        "--max_generations",
        type=float,
        default=float("inf"),
